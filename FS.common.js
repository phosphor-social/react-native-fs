...
var RNFS = {
	...
	copyFileRes(filename: string, destPath: string) {
		...
		return RNFSManager.copyFileRes(
			filename,
			normalizeFilePath(destPath)
		).then(() => void 0);
	},
	...
	copyAssetsFileIOS(imageUri: string, destPath: string): Promise<string> {
		return RNFSManager.copyAssetsFileIOS(imageUri, destPath);
	},
	...
	downloadFile(options: DownloadFileOptions): {
		...
		if (typeof options !== "object")
			throw new Error(
				"downloadFile: Invalid value for argument `options`"
			);
		if (typeof options.fromUrl !== "string")
			throw new Error(
				"downloadFile: Invalid value for property `fromUrl`"
			);
		if (typeof options.toFile !== "string")
			throw new Error(
				"downloadFile: Invalid value for property `toFile`"
			);
		if (options.headers && typeof options.headers !== "object")
			throw new Error(
				"downloadFile: Invalid value for property `headers`"
			);
		if (options.background && typeof options.background !== "boolean")
			throw new Error(
				"downloadFile: Invalid value for property `background`"
			);
		if (
			options.progressDivider &&
			typeof options.progressDivider !== "number"
		)
			throw new Error(
		...
		if (options.readTimeout && typeof options.readTimeout !== "number")
			throw new Error(
				"downloadFile: Invalid value for property `readTimeout`"
			);
		if (
	...
	uploadFiles(options: UploadFileOptions): {
		...
		if (typeof options !== "object")
			throw new Error(
				"uploadFiles: Invalid value for argument `options`"
			);
		...
		if (options.headers && typeof options.headers !== "object")
			throw new Error(
				"uploadFiles: Invalid value for property `headers`"
			);
